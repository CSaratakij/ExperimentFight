...
namespace ExperimentFight.Editor
{
    public class SpritePlotter : EditorWindow
    {
        ...
        void _GUIHandler()
        {
            ...
            if (currentSprite) {
                gameObjectEditor = UnityEditor.Editor.CreateEditor(currentSprite);
                gameObjectEditor.OnPreviewGUI(GUILayoutUtility.GetRect(100, 100), UnityEditor.EditorStyles.whiteLabel);
            }
